...
class Sheet(models.Model):
    ...
    Replicate                 = models.CharField(max_length = 250 , null = True)
    KaiChem_ID                = models.CharField(max_length = 250 , null = True)
    Compound_Name             = models.CharField(max_length = 250 , null = True)
    Compound_treatment_time   = models.CharField(max_length = 50 , null = True)
    ...
    RNA_Extraction_date       = models.DateTimeField(max_length = 150 , null = True)
    Library_Prep_date         = models.DateTimeField(max_length = 150 , null = True)
    Sample_sending_date_LAS   = models.DateTimeField(max_length = 250 , null = True)
